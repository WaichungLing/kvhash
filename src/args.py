...
def parse_args():
    ...
    parser.add_argument("--min_eviction_seqlen", type=int, default=2048, help="sequence length that starts eviction")  # put back 2048
    # pca
    parser.add_argument("--top_rank", type=int, default=64, help="top rank of principle components for PCA reduction")
    parser.add_argument("--quant_bit", type=int, default=4, help="quantization target bits")
    # tasks:
